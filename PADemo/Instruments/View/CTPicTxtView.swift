...
class CTPicTxtView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        mutableAttrStr.addAttributes([NSAttributedString.Key.font:UIFont.systemFont(ofSize: 20),
            NSAttributedString.Key.foregroundColor:UIColor.red], range: NSMakeRange(0, 5))
        mutableAttrStr.addAttributes([NSAttributedString.Key.font:UIFont.systemFont(ofSize: 13),NSAttributedString.Key.underlineStyle: 1 ], range: NSMakeRange(3,10))
...
//                let image = UIImage(named: imageName)
        ...
        imgString.addAttribute(NSAttributedString.Key(rawValue: String(kCTRunDelegateAttributeName)), value: runDelegate!, range: NSMakeRange(0, 1))  //rundelegate  占一个位置
        ...
        imgUrlString.addAttribute(NSAttributedString.Key(rawValue: String(kCTRunDelegateAttributeName)), value: urlRunDelegate!, range: NSMakeRange(0, 1))  //rundelegate  占一个位置
