...
class CTURLView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        self.spcialRanges = recognizeSpecialStringWithAttributed(attrStr: mutableAttrStr)
...
extension CTURLView:UIGestureRecognizerDelegate{
    ...
    func recognizeSpecialStringWithAttributed(attrStr:NSMutableAttributedString)->[NSRange]{
        ...
        //识别人名字
        // 2
        let atRegular = try? NSRegularExpression(pattern: regex_someone, options: NSRegularExpression.Options.caseInsensitive) //不区分大小写的
        // 3
        ...
        //识别链接
        let atRegular1 = try? NSRegularExpression(pattern: regex_url, options: NSRegularExpression.Options.caseInsensitive) //不区分大小写的
